namespace BookVault.Models
{
    public sealed class Book : EntityBase
    {
        ...
        private Book(string name, string genre, DateTimeOffset releaseDate, double rating)
        {
            Name = name;
            Genre = genre;
        ...
        public static Book Create(string name, string genre, DateTimeOffset releaseDate, double rating)
        {
            ValidateInputs(name, genre, releaseDate, rating);
            return new Book(name, genre, releaseDate, rating);
        }
