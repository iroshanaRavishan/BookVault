...
export default function Footer() {
  return (
    <footer className={styles.filmVaultFooter}>
      <div className={styles.footerMain}>
        <div className={styles.footerNewsletter}>
          <h3>Get the FilmVault Newsletter</h3>
        ...
        <div className={styles.footerLinks}>
          ...
          <div className={styles.footerColumn}>
            ...
            <ul>
              ...
              <li><Link to="/create">Add Films</Link></li>
              <li><Link to="/edit">Edit Films</Link></li>
              <li><Link to="/search">Search Added Films</Link></li>
              <li><Link to="/delete">Delete Films</Link></li>
            </ul>
          </div>
          
          <div className={styles.footerColumn}>
            <h4>FilmVault News</h4>
            <ul>
              <li><Link to="#">Film Industry</Link></li>
              <li><Link to="#">Interviews</Link></li>
              <li><Link to="#">Film Festivals</Link></li>
      ...
      <div className={styles.footerCopyright}>
        <p>© 2025 FilmVault Ltd. All Rights Reserved.</p>
      </div>
